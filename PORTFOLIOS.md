...
2. **Faster entry SMAs (asymmetric: fast entry, 10m exit) — REJECTED, and the gradient is the tell.** Modern era loves speed monotonically (5m entry: +10.2%/yr, maxDD −13% vs baseline +8.0%/−23% — the 2020-style V-bottom era rewards fast re-entry); pre-2007 dislikes it monotonically (5m: 8.7 vs 9.3, deeper DD — choppy bottoms punish it). Two opposite gradients; the 8m midpoint's apparent "pass" is just their crossing point, not an effect. Third member of the fast-re-entry graveyard (rebound accelerator, breadth thrust).
